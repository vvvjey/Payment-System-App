      ...
      <View style={styles.bodyContainer}>
        ...
        <View style={styles.mainServiceContainer}>
          <View style={styles.bodyMainService}>
            ...
            <TouchableOpacity style={styles.childMainService}>
              <Image
                source={IMAGES.ThanhToanHD}
                style={styles.iconThanhToanHD}
                resizeMode="contain"
              ></Image>
          ...
          <View style={styles.bodyMainService}>
            ...
            <TouchableOpacity style={styles.childMainService}>
              <Image
                source={IMAGES.DuLich}
                style={styles.iconDuLich}
                resizeMode="contain"
              ></Image>
            ...
            <TouchableOpacity style={styles.childMainService}>
              <Image
                source={IMAGES.XemThem}
                style={styles.iconXemThem}
                resizeMode="contain"
              ></Image>
        ...
        <View style={styles.otherServiceContainer}>
          <View style={styles.bodyMainService}>
            <TouchableOpacity style={styles.childMainService}>
              <Image
                source={IMAGES.TuThien}
                style={styles.iconTuThien}
                resizeMode="contain"
              ></Image>
              <Text style={styles.textMainService}>
                <Text style={{ color: Colors.DarkBlue }}>Nex</Text>
